...
import { Zap, Lock, ArrowRight, Loader2, CheckCircle2, Eye, EyeOff } from "lucide-react";
        ...
        <Card className="overflow-hidden border-border bg-card/70">
          <div className="flex items-center justify-between border-b border-border bg-background/40 px-4 py-2.5">
            <div className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-muted-foreground">
              <span className="h-1.5 w-1.5 rounded-full bg-success" /> Password Reset Terminal
            </div>
          </div>
            ...
            <form onSubmit={onSubmit} className="space-y-4 p-5">
              ...
              >
                {busy ? (
                  ...
                  <>
                    Reset Password <ArrowRight className="ml-1 h-3.5 w-3.5" />
                  </>
                )}
              </Button>
