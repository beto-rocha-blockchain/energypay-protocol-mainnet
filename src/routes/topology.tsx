  ...
  head: () => ({
    meta: [
      { title: "Energy Network Topology — EnergyPay" },
      {
        name: "description",
        content:
          "Interactive regional SCADA topology of generators, distributors, traders, consumers and investors.",
      },
    ],
  }),
      ...
      <div className="grid grid-cols-1 gap-3 xl:grid-cols-4">
        ...
        >
          <div className="relative aspect-[3/2] w-full overflow-hidden rounded-sm border border-border bg-background/40 grid-bg">
                ...
                return (
                  <g key={i}>
                    <line
                      ...
                      className={e.status === "FLOWING" ? "animate-flow-dash" : ""}
                    />
                  </g>
                );
              })}
            ...
            {/* Submercado labels */}
            <span className="absolute left-[42%] top-[5%] font-mono text-[9px] uppercase tracking-widest text-muted-foreground">
              N
            </span>
            <span className="absolute right-[6%] top-[20%] font-mono text-[9px] uppercase tracking-widest text-muted-foreground">
              NE
            </span>
            <span className="absolute left-[34%] top-[55%] font-mono text-[9px] uppercase tracking-widest text-muted-foreground">
              SE / CO
            </span>
            <span className="absolute left-[34%] bottom-[6%] font-mono text-[9px] uppercase tracking-widest text-muted-foreground">
              S
            </span>
          </div>
        ...
        <Panel title="Node Inspector" subtitle="Selected participant telemetry">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-sm border border-border bg-background/60">
              {(() => {
                const I = ICONS[sel.type] ?? Factory;
