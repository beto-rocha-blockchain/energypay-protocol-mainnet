...
export const mockSettlements: Settlement[] = [
  ...
  },
  {
    id: "STL-90210",
    contractId: "EPC-2037",
    counterparty: "Solaris Renewables",
    amountBRL: -19208,
    pld: 237.1,
    date: "2026-05-05 11:08",
    txHash: "b8d4e2912ca5b8d4e2912ca5b8d4e2912ca5b8d4e2912ca5b8d4e2912ca5b8d4",
    ledger: 58920512,
    latencyMs: 1980,
    window: "D+0 17:00 BRT",
  ...
  },
  {
    id: "STL-90209",
    contractId: "EPC-2035",
    counterparty: "Atlas Generation",
    amountBRL: 412900,
    pld: 268.0,
    date: "2026-05-04 17:54",
    txHash: "c1a7f03e8b91c1a7f03e8b91c1a7f03e8b91c1a7f03e8b91c1a7f03e8b91c1a7",
    ledger: 58919944,
    latencyMs: 2410,
    window: "D-1 17:00 BRT",
  ...
  },
  {
    id: "STL-90208",
    contractId: "EPC-2034",
    counterparty: "Meridian Trading Desk",
    amountBRL: 218750,
    pld: 261.5,
  ...
  },
  {
    id: "STL-90207",
    contractId: "EPC-2033",
    counterparty: "Horizon Power Exchange",
    amountBRL: 154600,
    pld: 254.9,
    date: "2026-05-03 16:12",
    txHash: "e2f7a188d310e2f7a188d310e2f7a188d310e2f7a188d310e2f7a188d310e2f7",
    ledger: 58919210,
    latencyMs: 2330,
    window: "D-2 17:00 BRT",
    state: "SETTLED",
    status: "CONFIRMED",
  },
];
...
export const operationalAlerts: AlertItem[] = [
  {
    id: "A-122",
    level: "warn",
    title: "Counterparty settlement delay detected",
    detail: "Horizon Power Exchange · ack pending > 90s on STL-90214",
    time: "12:18",
  },
  {
    id: "A-121",
    level: "warn",
    title: "Oracle synchronization latency",
    detail: "GridRef PLD feed · 6.2s lag vs. reference clock",
    time: "12:11",
  },
  {
    id: "A-120",
    ...
    detail: "STL-90209 · attempt 2/3 scheduled at T+00:05",
    time: "12:08",
  },
  {
    id: "A-119",
    ...
    detail: "Sub-mercado SE/CO · +14.2% over T-1 close",
    time: "12:04",
  },
  {
    id: "A-118",
    level: "info",
    title: "Pending reconciliation queue increasing",
    detail: "12 → 18 items in last 15 min",
    time: "11:52",
  },
  {
    id: "A-117",
    level: "info",
    title: "Counterparty onboarded",
    detail: "Northline Utilities added to clearing pool",
    time: "11:31",
  },
];
...
export const settlementQueue: QueueItem[] = [
  ...
  },
  {
    id: "STL-90215",
    contractId: "EPC-2039",
    counterparty: "Aurora Grid Energy",
    amount: 842400,
    eta: "02:38",
    phase: "queued",
    priority: "high",
  ...
  },
  {
    id: "STL-90217",
    contractId: "EPC-2042",
    counterparty: "Delta Industrial Load",
    amount: 188900,
    eta: "05:24",
    phase: "queued",
    priority: "low",
  ...
  },
  {
    id: "STL-90218",
    contractId: "EPC-2043",
    counterparty: "UrbanGrid Cooperative",
    amount: 96420,
    eta: "07:02",
    phase: "queued",
    priority: "low",
